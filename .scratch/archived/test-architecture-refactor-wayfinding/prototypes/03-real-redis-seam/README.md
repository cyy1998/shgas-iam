...
```text
node .scratch/archived/test-architecture-refactor-wayfinding/prototypes/03-real-redis-seam/prototype.mjs
```
非交互快照：

```text
node .scratch/archived/test-architecture-refactor-wayfinding/prototypes/03-real-redis-seam/prototype.mjs --snapshot
```
