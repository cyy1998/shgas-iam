...
export const PosOrgRoleFindManySchema: z.ZodType<Prisma.PosOrgRoleFindManyArgs> = z.object({ select: PosOrgRoleFindManySelectSchema.optional(),  orderBy: z.union([PosOrgRoleOrderByWithRelationInputObjectSchema, PosOrgRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosOrgRoleWhereInputObjectSchema.optional(), cursor: PosOrgRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosOrgRoleScalarFieldEnumSchema, PosOrgRoleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PosOrgRoleFindManyArgs>;

export const PosOrgRoleFindManyZodSchema = z.object({ select: PosOrgRoleFindManySelectSchema.optional(),  orderBy: z.union([PosOrgRoleOrderByWithRelationInputObjectSchema, PosOrgRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosOrgRoleWhereInputObjectSchema.optional(), cursor: PosOrgRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosOrgRoleScalarFieldEnumSchema, PosOrgRoleScalarFieldEnumSchema.array()]).optional() }).strict();