...
export const RolePrivilegeFindFirstSelectSchema: z.ZodType<Prisma.RolePrivilegeSelect> = z.object({
...
export const RolePrivilegeFindFirstSelectZodSchema = z.object({
    roleId: z.boolean().optional(),
    privilegeId: z.boolean().optional(),
    role: z.boolean().optional(),
    privilege: z.boolean().optional()
...
export const RolePrivilegeFindFirstSchema: z.ZodType<Prisma.RolePrivilegeFindFirstArgs> = z.object({ select: RolePrivilegeFindFirstSelectSchema.optional(),  orderBy: z.union([RolePrivilegeOrderByWithRelationInputObjectSchema, RolePrivilegeOrderByWithRelationInputObjectSchema.array()]).optional(), where: RolePrivilegeWhereInputObjectSchema.optional(), cursor: RolePrivilegeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RolePrivilegeScalarFieldEnumSchema, RolePrivilegeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RolePrivilegeFindFirstArgs>;

export const RolePrivilegeFindFirstZodSchema = z.object({ select: RolePrivilegeFindFirstSelectSchema.optional(),  orderBy: z.union([RolePrivilegeOrderByWithRelationInputObjectSchema, RolePrivilegeOrderByWithRelationInputObjectSchema.array()]).optional(), where: RolePrivilegeWhereInputObjectSchema.optional(), cursor: RolePrivilegeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RolePrivilegeScalarFieldEnumSchema, RolePrivilegeScalarFieldEnumSchema.array()]).optional() }).strict();