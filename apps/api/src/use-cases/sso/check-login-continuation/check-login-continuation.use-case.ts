import type { CheckSsoLoginContinuationDeps } from "./check-login-continuation.port";
import type { CheckSsoLoginContinuationInput } from "./check-login-continuation.type";
...
export function createCheckSsoLoginContinuationUseCase(
...
export type CheckSsoLoginContinuationUseCase
  = ReturnType<typeof createCheckSsoLoginContinuationUseCase>;
