...
export const EmploymentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.EmploymentSelect> = z.object({
...
export const EmploymentFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    posId: z.boolean().optional(),
    orgId: z.boolean().optional(),
...
export const EmploymentFindFirstOrThrowSchema: z.ZodType<Prisma.EmploymentFindFirstOrThrowArgs> = z.object({ select: EmploymentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EmploymentIncludeObjectSchema.optional()), orderBy: z.union([EmploymentOrderByWithRelationInputObjectSchema, EmploymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EmploymentWhereInputObjectSchema.optional(), cursor: EmploymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EmploymentScalarFieldEnumSchema, EmploymentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.EmploymentFindFirstOrThrowArgs>;

export const EmploymentFindFirstOrThrowZodSchema = z.object({ select: EmploymentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => EmploymentIncludeObjectSchema.optional()), orderBy: z.union([EmploymentOrderByWithRelationInputObjectSchema, EmploymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: EmploymentWhereInputObjectSchema.optional(), cursor: EmploymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([EmploymentScalarFieldEnumSchema, EmploymentScalarFieldEnumSchema.array()]).optional() }).strict();