...
export const PrivilegeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PrivilegeSelect> = z.object({
...
export const PrivilegeFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    privilegeCode: z.boolean().optional(),
    privilegeName: z.boolean().optional(),
    fieldValues: z.boolean().optional(),
...
export const PrivilegeFindFirstOrThrowSchema: z.ZodType<Prisma.PrivilegeFindFirstOrThrowArgs> = z.object({ select: PrivilegeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PrivilegeIncludeObjectSchema.optional()), orderBy: z.union([PrivilegeOrderByWithRelationInputObjectSchema, PrivilegeOrderByWithRelationInputObjectSchema.array()]).optional(), where: PrivilegeWhereInputObjectSchema.optional(), cursor: PrivilegeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrivilegeScalarFieldEnumSchema, PrivilegeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PrivilegeFindFirstOrThrowArgs>;

export const PrivilegeFindFirstOrThrowZodSchema = z.object({ select: PrivilegeFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PrivilegeIncludeObjectSchema.optional()), orderBy: z.union([PrivilegeOrderByWithRelationInputObjectSchema, PrivilegeOrderByWithRelationInputObjectSchema.array()]).optional(), where: PrivilegeWhereInputObjectSchema.optional(), cursor: PrivilegeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PrivilegeScalarFieldEnumSchema, PrivilegeScalarFieldEnumSchema.array()]).optional() }).strict();