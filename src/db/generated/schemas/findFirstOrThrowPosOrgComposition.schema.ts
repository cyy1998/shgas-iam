...
export const PosOrgCompositionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PosOrgCompositionSelect> = z.object({
...
export const PosOrgCompositionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    posId: z.boolean().optional(),
    orgId: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const PosOrgCompositionFindFirstOrThrowSchema: z.ZodType<Prisma.PosOrgCompositionFindFirstOrThrowArgs> = z.object({ select: PosOrgCompositionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PosOrgCompositionIncludeObjectSchema.optional()), orderBy: z.union([PosOrgCompositionOrderByWithRelationInputObjectSchema, PosOrgCompositionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosOrgCompositionWhereInputObjectSchema.optional(), cursor: PosOrgCompositionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosOrgCompositionScalarFieldEnumSchema, PosOrgCompositionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PosOrgCompositionFindFirstOrThrowArgs>;

export const PosOrgCompositionFindFirstOrThrowZodSchema = z.object({ select: PosOrgCompositionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PosOrgCompositionIncludeObjectSchema.optional()), orderBy: z.union([PosOrgCompositionOrderByWithRelationInputObjectSchema, PosOrgCompositionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosOrgCompositionWhereInputObjectSchema.optional(), cursor: PosOrgCompositionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosOrgCompositionScalarFieldEnumSchema, PosOrgCompositionScalarFieldEnumSchema.array()]).optional() }).strict();