...
export const PosOrgRoleFindFirstSchema: z.ZodType<Prisma.PosOrgRoleFindFirstArgs> = z.object({ select: PosOrgRoleFindFirstSelectSchema.optional(), include: z.lazy(() => PosOrgRoleIncludeObjectSchema.optional()), orderBy: z.union([PosOrgRoleOrderByWithRelationInputObjectSchema, PosOrgRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosOrgRoleWhereInputObjectSchema.optional(), cursor: PosOrgRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosOrgRoleScalarFieldEnumSchema, PosOrgRoleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PosOrgRoleFindFirstArgs>;

export const PosOrgRoleFindFirstZodSchema = z.object({ select: PosOrgRoleFindFirstSelectSchema.optional(), include: z.lazy(() => PosOrgRoleIncludeObjectSchema.optional()), orderBy: z.union([PosOrgRoleOrderByWithRelationInputObjectSchema, PosOrgRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosOrgRoleWhereInputObjectSchema.optional(), cursor: PosOrgRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosOrgRoleScalarFieldEnumSchema, PosOrgRoleScalarFieldEnumSchema.array()]).optional() }).strict();