...
export const OrganizationRoleFindFirstOrThrowSelectSchema: z.ZodType<Prisma.OrganizationRoleSelect> = z.object({
...
export const OrganizationRoleFindFirstOrThrowSelectZodSchema = z.object({
    organizationId: z.boolean().optional(),
    roleId: z.boolean().optional(),
    isAllSub: z.boolean().optional(),
    organization: z.boolean().optional(),
...
export const OrganizationRoleFindFirstOrThrowSchema: z.ZodType<Prisma.OrganizationRoleFindFirstOrThrowArgs> = z.object({ select: OrganizationRoleFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OrganizationRoleIncludeObjectSchema.optional()), orderBy: z.union([OrganizationRoleOrderByWithRelationInputObjectSchema, OrganizationRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrganizationRoleWhereInputObjectSchema.optional(), cursor: OrganizationRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrganizationRoleScalarFieldEnumSchema, OrganizationRoleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OrganizationRoleFindFirstOrThrowArgs>;

export const OrganizationRoleFindFirstOrThrowZodSchema = z.object({ select: OrganizationRoleFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OrganizationRoleIncludeObjectSchema.optional()), orderBy: z.union([OrganizationRoleOrderByWithRelationInputObjectSchema, OrganizationRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrganizationRoleWhereInputObjectSchema.optional(), cursor: OrganizationRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrganizationRoleScalarFieldEnumSchema, OrganizationRoleScalarFieldEnumSchema.array()]).optional() }).strict();