...
export const RolePrivilegeFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RolePrivilegeSelect> = z.object({
...
export const RolePrivilegeFindFirstOrThrowSelectZodSchema = z.object({
    roleId: z.boolean().optional(),
    privilegeId: z.boolean().optional(),
    role: z.boolean().optional(),
    privilege: z.boolean().optional()
