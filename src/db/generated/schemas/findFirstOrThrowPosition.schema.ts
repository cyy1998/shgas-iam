...
export const PositionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.PositionSelect> = z.object({
...
export const PositionFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    posCode: z.boolean().optional(),
    posName: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const PositionFindFirstOrThrowSchema: z.ZodType<Prisma.PositionFindFirstOrThrowArgs> = z.object({ select: PositionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PositionIncludeObjectSchema.optional()), orderBy: z.union([PositionOrderByWithRelationInputObjectSchema, PositionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PositionWhereInputObjectSchema.optional(), cursor: PositionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PositionScalarFieldEnumSchema, PositionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PositionFindFirstOrThrowArgs>;

export const PositionFindFirstOrThrowZodSchema = z.object({ select: PositionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => PositionIncludeObjectSchema.optional()), orderBy: z.union([PositionOrderByWithRelationInputObjectSchema, PositionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PositionWhereInputObjectSchema.optional(), cursor: PositionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PositionScalarFieldEnumSchema, PositionScalarFieldEnumSchema.array()]).optional() }).strict();