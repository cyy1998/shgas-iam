...
const makeSchema = () => z.object({
  ...
  clientCode: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  clientName: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  clientSecret: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
...
export const ClientUncheckedUpdateWithoutRolesInputObjectSchema: z.ZodType<Prisma.ClientUncheckedUpdateWithoutRolesInput> = makeSchema() as unknown as z.ZodType<Prisma.ClientUncheckedUpdateWithoutRolesInput>;
export const ClientUncheckedUpdateWithoutRolesInputObjectZodSchema = makeSchema();
