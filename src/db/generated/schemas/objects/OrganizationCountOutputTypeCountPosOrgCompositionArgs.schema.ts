...
export const OrganizationCountOutputTypeCountPosOrgCompositionArgsObjectSchema = makeSchema();
export const OrganizationCountOutputTypeCountPosOrgCompositionArgsObjectZodSchema = makeSchema();
