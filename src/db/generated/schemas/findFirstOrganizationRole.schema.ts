...
export const OrganizationRoleFindFirstSchema: z.ZodType<Prisma.OrganizationRoleFindFirstArgs> = z.object({ select: OrganizationRoleFindFirstSelectSchema.optional(), include: z.lazy(() => OrganizationRoleIncludeObjectSchema.optional()), orderBy: z.union([OrganizationRoleOrderByWithRelationInputObjectSchema, OrganizationRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrganizationRoleWhereInputObjectSchema.optional(), cursor: OrganizationRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrganizationRoleScalarFieldEnumSchema, OrganizationRoleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OrganizationRoleFindFirstArgs>;

export const OrganizationRoleFindFirstZodSchema = z.object({ select: OrganizationRoleFindFirstSelectSchema.optional(), include: z.lazy(() => OrganizationRoleIncludeObjectSchema.optional()), orderBy: z.union([OrganizationRoleOrderByWithRelationInputObjectSchema, OrganizationRoleOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrganizationRoleWhereInputObjectSchema.optional(), cursor: OrganizationRoleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrganizationRoleScalarFieldEnumSchema, OrganizationRoleScalarFieldEnumSchema.array()]).optional() }).strict();