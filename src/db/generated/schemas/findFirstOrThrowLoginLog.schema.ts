...
export const LoginLogFindFirstOrThrowSelectSchema: z.ZodType<Prisma.LoginLogSelect> = z.object({
...
export const LoginLogFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    userId: z.boolean().optional(),
    username: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const LoginLogFindFirstOrThrowSchema: z.ZodType<Prisma.LoginLogFindFirstOrThrowArgs> = z.object({ select: LoginLogFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([LoginLogOrderByWithRelationInputObjectSchema, LoginLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: LoginLogWhereInputObjectSchema.optional(), cursor: LoginLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LoginLogScalarFieldEnumSchema, LoginLogScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LoginLogFindFirstOrThrowArgs>;

export const LoginLogFindFirstOrThrowZodSchema = z.object({ select: LoginLogFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([LoginLogOrderByWithRelationInputObjectSchema, LoginLogOrderByWithRelationInputObjectSchema.array()]).optional(), where: LoginLogWhereInputObjectSchema.optional(), cursor: LoginLogWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LoginLogScalarFieldEnumSchema, LoginLogScalarFieldEnumSchema.array()]).optional() }).strict();