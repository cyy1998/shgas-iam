...
export const PosOrgCompositionFindFirstSelectSchema: z.ZodType<Prisma.PosOrgCompositionSelect> = z.object({
...
export const PosOrgCompositionFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    posId: z.boolean().optional(),
    orgId: z.boolean().optional(),
    status: z.boolean().optional(),
...
export const PosOrgCompositionFindFirstSchema: z.ZodType<Prisma.PosOrgCompositionFindFirstArgs> = z.object({ select: PosOrgCompositionFindFirstSelectSchema.optional(),  orderBy: z.union([PosOrgCompositionOrderByWithRelationInputObjectSchema, PosOrgCompositionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosOrgCompositionWhereInputObjectSchema.optional(), cursor: PosOrgCompositionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosOrgCompositionScalarFieldEnumSchema, PosOrgCompositionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PosOrgCompositionFindFirstArgs>;

export const PosOrgCompositionFindFirstZodSchema = z.object({ select: PosOrgCompositionFindFirstSelectSchema.optional(),  orderBy: z.union([PosOrgCompositionOrderByWithRelationInputObjectSchema, PosOrgCompositionOrderByWithRelationInputObjectSchema.array()]).optional(), where: PosOrgCompositionWhereInputObjectSchema.optional(), cursor: PosOrgCompositionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PosOrgCompositionScalarFieldEnumSchema, PosOrgCompositionScalarFieldEnumSchema.array()]).optional() }).strict();