...
import { createPostgresTestHarness } from "../postgres/postgres-test-harness";
import { createRedisTestHarness } from "../redis/redis-test-harness";

// These failure paths stop before resource creation; real isolation stays in resource contracts.
test.each([
  { name: "IAM_USER_PROFILE_TEST_DATABASE_URL", create: createPostgresTestHarness },
  { name: "IAM_USER_PROFILE_TEST_REDIS_URL", create: createRedisTestHarness },
