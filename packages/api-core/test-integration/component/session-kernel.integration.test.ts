...
import type { SessionKernelRedis, SessionKernelRedisTransaction } from "../../src/session/kernel";
...
import * as sessionKernelPublicModule from "../../src/session/kernel";
import { createSessionKernelForTesting } from "../../src/session/kernel/testing";
