...
| [docs/adr/0032-consume-published-subject-facts-for-authorization.md](adr/0032-consume-published-subject-facts-for-authorization.md) | decision | Current | 2026-09-09 | 2026-10-31 | Accepted：#156 双协议采用 Redis 优先、缓存失效回源的已发布事实；接受旧权限，保留登录及协议版本，以行为验证验收；代码已实现、环境未切换。 |
...
| [docs/architecture/contracts-and-database.md](architecture/contracts-and-database.md) | architecture | Current | 2026-09-09 | 2026-10-31 | 共享代码选址、纯规则与后端 DTO 分层、公开接口、建包条件、DTO 字段演进与渐进收敛；保留专用能力包、事务与 Drizzle 契约。 |
...
| [docs/features/sso/custom-sso-credential-authority-evidence.md](features/sso/custom-sso-credential-authority-evidence.md) | feature | Current | 2026-09-09 | 2026-10-31 | #166 Custom SSO 凭据独立访问、根撤销漏项及受控晚到签发的 HTTP/Redis 证明；保存三路径前后实际命令、RTT 区间与串行波次，明确局部替身和未部署边界。 |
...
| [docs/features/sso/published-subject-facts-contract.md](features/sso/published-subject-facts-contract.md) | feature | Current | 2026-09-09 | 2026-10-31 | #156 已发布权限、Reader 与协议行为证据、旧断言迁移及环境证明边界。 |
...
| [docs/releases/custom-sso-one-shot-grant-upgrade.md](releases/custom-sso-one-shot-grant-upgrade.md) | runbook | Current | 2026-09-10 | 2026-10-31 | #161 保留会话统一升级：基线、writer/consumer、停流排空、定向清理/独立保留、统一版本、smoke、一次放流及回退；环境未执行。 |
...
| [docs/releases/oidc-release-runbook.md](releases/oidc-release-runbook.md) | runbook | Current | 2026-09-10 | 2026-10-31 | OIDC 当前架构发布、JWK/HMAC rotation 与回滚；Spec #146 单独升级保留对象，包含 Spec #163 则优先全体下线；旧 Session 迁移另行安排。 |
| [docs/releases/online-auth-redis-time-cutover.md](releases/online-auth-redis-time-cutover.md) | runbook | Current | 2026-09-10 | 2026-10-31 | Spec #163 全体下线发布与当前 Kernel/Grant/OIDC 直接 owner 扫描清理、独立 verify、停流排空与统一版本、失败重跑/回退、保留集及 Redis 主机责任；环境未执行。 |
...
| [docs/releases/protocol-validation-preserving-upgrade.md](releases/protocol-validation-preserving-upgrade.md) | runbook | Current | 2026-09-10 | 2026-10-31 | Spec #146 当前格式停流、冻结、drain、统一版本与保留有效对象升级；原规格单独升级不全清；包含 Spec #163 则按全体下线例外，双向误投/合法 smoke 与失败处置保持，环境未执行。 |
| [docs/releases/published-subject-facts-upgrade.md](releases/published-subject-facts-upgrade.md) | runbook | Current | 2026-09-10 | 2026-10-31 | #156 单独升级保留会话/快照，包含 Spec #163 则按全体下线例外；受控 smoke 与统一回退，目标环境未执行。 |
