...
| [docs/adr/0021-bind-protocol-runtime-cache-consistency-to-snapshot-acquisition.md](adr/0021-bind-protocol-runtime-cache-consistency-to-snapshot-acquisition.md) | decision | Current | 2026-09-03 | 2026-10-31 | #27 已实现：deep Runtime Snapshot Module、target-bound Admin mutation wrapper、三类 Runtime acquisition、legacy 在线协议退役、targeted/full Worker repair 与独立 verify；production 首次激活仍需维护者按 runbook 单独授权。 |
| [docs/adr/0022-adopt-snapshot-consistency-for-client-traffic-gate.md](adr/0022-adopt-snapshot-consistency-for-client-traffic-gate.md) | decision | Current | 2026-09-03 | 2026-10-31 | 已实现 Client Traffic Gate Snapshot acquisition、强 fencing 移除、传播失败窗口、targeted/full Worker repair 与独立 verify。 |
...
| [docs/architecture/backend-architecture.md](architecture/backend-architecture.md) | architecture | Current | 2026-08-23 | 2026-10-31 | 后端 runtime ownership、依赖方向、composition/DI、User Profile v3、Client Protocol V2 当前边界、UnitOfWork/afterCommit、关键 deep modules 和分层验证。 |
| [docs/architecture/contracts-and-database.md](architecture/contracts-and-database.md) | architecture | Current | 2026-08-22 | 2026-10-31 | shared contracts、domain/db/jobs/role-assignment-resolution、User Profile v3 read-model 边界、UnitOfWork/afterCommit 和 Drizzle schema/relations/migration 约定。 |
...
| [docs/architecture/repository-map.md](architecture/repository-map.md) | architecture | Current | 2026-08-22 | 2026-10-31 | monorepo apps/packages、User Profile v3 read-model、root-owned E2E workspace、gateway/observability 基础设施、agent workflow roots 与生成目录边界。 |
...
| [docs/development/commands.md](development/commands.md) | development | Current | 2026-08-22 | 2026-10-31 | 聚焦实现、canonical Unit/Integration commands、默认 verify、显式资源 profiles、Architecture Guard、性能与 commit guard 的可执行入口。 |
...
| [docs/releases/client-runtime-snapshot-hard-cutover.md](releases/client-runtime-snapshot-hard-cutover.md) | runbook | Current | 2026-09-03 | 2026-10-31 | Release owner 按 runbook 逐项执行 owner commands，并固定 Runtime Snapshot 新旧 namespace reset、人工 PONR receipt、Worker repair/verify、mutation/acquisition smoke 与 forward-only 放流合同；真实 production 执行仍需维护者单独授权。 |
...
| [docs/releases/oidc-release-runbook.md](releases/oidc-release-runbook.md) | runbook | Current | 2026-08-09 | 2026-10-31 | OIDC Provider 发布、staged payload rollout、JWK/HMAC rotation、逐 client smoke 和回滚手册。 |
