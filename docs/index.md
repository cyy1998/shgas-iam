...
| [docs/features/sso/custom-authorization-candidate.md](features/sso/custom-authorization-candidate.md) | feature | Current | 2026-09-14 | 2026-10-31 | #184 Custom 单回调授权、续接与 Code；#185/#186 兑换和托管消费已交付，#194 已默认接线。 |
...
| [docs/features/sso/custom-managed-candidate.md](features/sso/custom-managed-candidate.md) | feature | Current | 2026-09-14 | 2026-10-31 | #186 托管 callback、同 owner Token、ORCAS 交付、Cookie 与最小 Header；Q38 失败边界及真实 HTTP/Redis 替身证明，环境未切换。 |
