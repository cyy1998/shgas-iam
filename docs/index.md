...
| [docs/architecture/testing-architecture.md](architecture/testing-architecture.md) | architecture | Current | 2026-09-07 | 2026-10-31 | Unit/Integration/E2E canonical collections、资源预算与验证契约；每票与最终聚合入口包含 Collection Guard，关键证据链接验证归属。 |
