...
| [docs/architecture/backend-architecture.md](architecture/backend-architecture.md) | architecture | Current | 2026-08-22 | 2026-10-31 | 后端 runtime ownership、依赖方向、composition/DI、User Profile v3、UnitOfWork/afterCommit、请求与审计上下文、关键 deep modules、OIDC/Worker lifecycle 和分层验证。 |
...
| [docs/features/user-profile-search/filter-dsl.md](features/user-profile-search/filter-dsl.md) | design | Current | 2026-08-22 | 2026-10-31 | 已激活的 User Profile Filter DSL v3 规则；全部搜索入口使用 canonical Filter engine，旧责任限定 DSL 已撤销。 |
...
| [docs/releases/client-protocol-v2-artifact-cutover.md](releases/client-protocol-v2-artifact-cutover.md) | runbook | Current | 2026-08-21 | 2026-10-31 | Client Protocol V2 owner checklist、epoch 不可逆边界、精确 artifact dry-run/apply/verify 与 forward-only 失败处理。 |
