...
| [docs/releases/organization-responsibility-v2-hard-cutover.md](releases/organization-responsibility-v2-hard-cutover.md) | runbook | Current | 2026-08-21 | 2026-10-31 | Organization Responsibility strict V2 的完整 freeze、双 data gate、epoch/cleanup、Full-system/release smoke、一次性放流与 forward-only 回滚边界。 |
