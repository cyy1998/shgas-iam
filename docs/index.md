...
| [docs/development/commands.md](development/commands.md) | development | Current | 2026-09-07 | 2026-10-31 | 聚焦实现、canonical Unit/Integration commands、每票 verify:static 与完整 verify、显式资源 profiles、Architecture Guard、性能与 commit guard 的可执行入口；Employment 全库诊断统一为 employment:verify；Subject Access repair 包含 PostgreSQL intent 回收。 |
