...
- 新增 SSO 和 Admin 前端 nginx 静态容器，并让 APISIX 根据前端根路径代理到对应容器。
...
- 影响系统：APISIX、etcd、公共 API `apps/api`、管理 API `apps/admin-api`、SSO 前端 `apps/sso`、管理前端 `apps/admin`、第三方业务应用 upstream。
