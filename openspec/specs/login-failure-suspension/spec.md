# login-failure-suspension Specification

## Purpose
Protect global password and mobile verification-code login by tracking repeated credential failures, warning users about remaining attempts, and pausing enabled accounts that reach the configured failure threshold.
