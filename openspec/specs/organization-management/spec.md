...
## Evidence Review
- 管理端暴露组织管理操作: 证据 `apps/admin-api/src/routes/admin/organization/organization.adapter.ts`, `apps/admin-api/src/routes/admin/organization/organization.index.ts`, `apps/admin-api/src/routes/admin/organization/organization.routes.ts`, `apps/admin-api/src/routes/admin/organization/organization.trpc.ts`。状态: 有代码证据；权限边界未纳入。
