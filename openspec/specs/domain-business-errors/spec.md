# domain-business-errors Specification

## Purpose
Define where stable business error classes live and how domain-owned errors interoperate with backend API error handling without coupling domain code to API infrastructure.
